...
## 📋 RULE PROPAGATION (CRITICAL)

**ALWAYS copy these claude.md rules to ANY new projects or forks of KimbleAI.**

### When to Apply:
- Creating new projects based on KimbleAI
- Forking KimbleAI for different purposes
- Setting up KimbleAI variants (v5, v6, etc.)
- Migrating KimbleAI to new infrastructure

### How to Apply:
1. Copy this entire `.claude.md` file to the new project root
2. Update project-specific references (names, URLs, etc.)
3. Keep all workflow rules intact (timestamps, deploy, version tracking)
4. Add any project-specific rules as additional sections

**These rules represent best practices developed through KimbleAI - propagate them!**
