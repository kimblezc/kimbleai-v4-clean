-- ================================================================
-- QUICK FIX V2: Minimum changes to make project creation work
-- ================================================================
-- FIXED: Use name='Zach' instead of id='zach' (id is UUID type)
-- ================================================================
...
-- 4. Make user 'Zach' an admin with full permissions (using name instead of id)
UPDATE users
SET
  role = 'admin',
  permissions = '{
...
SELECT id, name, role, permissions->'can_create_projects' as can_create FROM users WHERE name = 'Zach';
