/**
 * Task Forge Dashboard - Archie's Task Queue
 *
 * Detailed view of Archie's autonomous task management:
...
export const metadata = {
  title: 'Task Forge - Archie Task Dashboard',
  description: 'Real-time monitoring and analytics for Archie autonomous task agent'
};
...
export default async function TaskForgeDashboard() {
        ...
        <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-6">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-4xl font-bold text-white">Task Forge</h1>
            </div>
            <p className="text-slate-400 text-lg">
              Archie's autonomous task management and execution dashboard
            </p>
          </div>
