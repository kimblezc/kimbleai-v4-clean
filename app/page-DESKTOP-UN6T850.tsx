...
export default function Home() {
  ...
  }, [currentUser, deletedProjects, createdProjects]);
        ...
        <div style={{
          ...
          {messages.length === 0 && (
            <div style={{
              ...
              <p style={{ fontSize: '16px', margin: 0, marginBottom: '24px' }}>
